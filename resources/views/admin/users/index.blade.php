...
@section('content')
    <div class="container-fluid px-2 px-md-4">
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center mb-3 gap-2">
            ...
            <a href="{{ route($routePrefix . 'create', $routeParams ?? []) }}" class="btn btn-primary btn-sm">
        ...
        <div class="card shadow-sm border-0 mb-3">
            <div class="card-body p-2 p-md-3">
                <div class="d-flex flex-column flex-md-row gap-2 align-items-start align-items-md-center">
                    <div class="col-auto">
                        <form method="GET" action="{{ route($routePrefix . 'index', $routeParams ?? []) }}" id="perPageForm" class="d-flex align-items-center">
                    ...
                    <div class="ms-md-auto w-100 w-md-auto">
                        <form method="GET" action="{{ route($routePrefix . 'index', $routeParams ?? []) }}" class="d-flex">
                            <div class="input-group input-group-sm">
                                ...
                                @if(request('search'))
                                    <a href="{{ route($routePrefix . 'index', $routeParams ?? []) }}" class="btn btn-outline-secondary">
                                        <i class="bi bi-x"></i>
                                    </a>
                                @endif
                            </div>
                    ...
                    @forelse($users as $user)
                        <tr>
                            ...
                            <td class="text-end px-4">
                                <!-- View Button -->
                                <a href="{{ route($routePrefix . 'show', array_merge($routeParams ?? [], [$user])) }}"
                                ...
                                <!-- Edit Button -->
                                <a href="{{ route($routePrefix . 'edit', array_merge($routeParams ?? [], [$user])) }}"
                                        ...
                                        <div class="modal-content border-0 shadow">
                                            <div class="modal-body p-4 text-center position-relative">
                                                ...
                                                <div class="d-flex gap-2 justify-content-center">
                                                    ...
                                                    <form action="{{ route($routePrefix . 'destroy', array_merge($routeParams ?? [], [$user])) }}" method="POST">
                                                        @csrf @method('DELETE')
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-sm">
                                        <div class="modal-content border-0 shadow">
                                            <div class="modal-body p-4 text-center">
                                                ...
                                                <div class="d-flex gap-2 justify-content-center">
                                                    <button type="button" class="btn btn-sm btn-light px-4" data-bs-dismiss="modal">Cancel</button>
                                                    <form action="{{ route($routePrefix . 'status', array_merge($routeParams ?? [], [$user])) }}" method="POST">
                                                        @csrf @method('PATCH')
