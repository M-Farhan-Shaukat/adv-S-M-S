...
class ComplaintController extends Controller
{
    ...
    public function resolve(Request $request, string $school, Complaint $complaint)
    {
    ...
    public function updateStatus(Request $request, string $school, Complaint $complaint)
    {
